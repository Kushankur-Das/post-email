 ...
 */
define( 'POSTEMAIL_VERSION', '1.0.0' );

/**
 * The code that runs during plugin activation.
 * This action is documented in includes/class-postemail-activator.php
 */
function activate_postemail() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-postemail-activator.php';
	Postemail_Activator::activate();
}

/**
 * The code that runs during plugin deactivation.
 * This action is documented in includes/class-postemail-deactivator.php
 */
function deactivate_postemail() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-postemail-deactivator.php';
	Postemail_Deactivator::deactivate();
}

register_activation_hook( __FILE__, 'activate_postemail' );
register_deactivation_hook( __FILE__, 'deactivate_postemail' );

/**
 * The core plugin class that is used to define internationalization,
 * admin-specific hooks, and public-facing site hooks.
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-postemail.php';
 ...
 * @since    1.0.0
 */
function run_postemail() {

	$plugin = new Postemail();
	$plugin->run();
